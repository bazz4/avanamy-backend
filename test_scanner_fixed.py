...
export async function updateProvider(providerId: string, data: ProviderUpdate): Promise<Provider> {
...
for match in matches:
    print(f"  Line {match.line_number}: {match.http_method} {match.endpoint_path} (confidence: {match.confidence})")
